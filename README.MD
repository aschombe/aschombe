...
- Tools and Platforms:
    ...
    [![Amazon Web Services](https://img.shields.io/badge/AWS-333333?logo=amazonwebservices)](https://aws.amazon.com/)

## Certifications
- [AWS Certified Cloud Practitioner](https://www.credly.com/badges/2349076b-9202-4663-a7e6-ce82079a753b/public_url)

## Current Projects
- [aarch64-emulator](https://github.com/aschombe/aarch64-emulator) - A modular and extensible AArch64 emulator written in Rust.
